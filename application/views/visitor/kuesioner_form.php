...
margin: 2vh 0;">
			...
			<div class="card-footer" style="padding-top: 1rem;">
				...
				<!-- cloud check icon -->
				<button type="button" class="btn btn-sm btn-autosave-info" data-bs-toggle="modal" data-bs-target="#modalAutoSaveDetail" style="float: right;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cloud-check" viewBox="0 0 16 16">
				...
				foreach ($formdata as $key => $value) {
					...
					if($value['elementtype'] == 'text' || $value['elementtype'] == 'email' || $value['elementtype'] == 'number') {
						...
						<div class="form__group field">
							...
							<label for="<?= $value['prefix'] ?>" class="form__label"><?= $value['elementname'] ?><?= $value['required'] == true ? '*' : '' ?></label>
						</div>
						<?php
					}
...
transform: scale(1.4);"><?php echo $no ?></span>
				<div class="card-body">
					...
					<p class="card-text"><?php echo $value->isi_diskusi ?><span class="text-danger">*</span></p>
