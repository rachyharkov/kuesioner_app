...
margin: 2vh 0;">
		  	...
		  	<div>
		  		<p>Terdapat dua (2) kolom respon yang masing-masing terdapat pilihan, pada pilihan berikut terdapat singkatan:</p>
...
justify-content: center;">
	...
	<div class="container" style="padding: 11vh 0; display: block;scroll-snap-align: start;">
		<div class="card" style="width: 100%;">
		  <div class="card-body">
		  	<div style="width: 100%;
text-align: center;
margin: 2vh 0;">
			...
			<div class="form-group">
				<select class="form-select" aria-label="Default select" name="asal_perusahaan" style="margin: 3vh 0;">
